...
namespace TracingExperiment.Helpers.Controls
{
    ...
    public interface ITableBuilderT<TModel> : ITableApply<ITableBuilderT<TModel>>
    {
        ...
        /// <returns></returns>
        IColumnBuilderT<TModel> Apply<TProperty>(Expression<Func<TModel, TProperty>> expression, System.Web.Mvc.ColumnOption option, object[] value);
        ...
        /// <returns></returns>
        IColumnBuilderT<TModel> Apply<TProperty>(Expression<Func<TModel, TProperty>> expression, params System.Web.Mvc.ColumnOption[] options);
        ...
        /// <param name="options">Column option(s) to apply</param>
        /// <returns></returns>
        IColumnBuilderT<TModel> Cease<TProperty>(Expression<Func<TModel, TProperty>> expression, params System.Web.Mvc.ColumnOption[] options);
